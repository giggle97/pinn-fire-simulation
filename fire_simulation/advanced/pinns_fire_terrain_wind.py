...
# 保存
plt.savefig('../../results/fire_advanced_results/pinns_fire_terrain_wind_result.png', dpi=300, bbox_inches='tight')
print("✅ 结果已保存为 '../../results/fire_advanced_results/pinns_fire_terrain_wind_result.png'")
...
plt.savefig('../../results/fire_advanced_results/training_loss.png')
